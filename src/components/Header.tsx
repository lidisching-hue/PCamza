        ...
        <div className="max-w-7xl mx-auto px-4 py-2.5 flex flex-col sm:flex-row justify-between items-center text-sm gap-2 sm:gap-0">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://www.instagram.com/perkam4" target="_blank" rel="noopener noreferrer" className="text-white hover:text-pink-400 transition-colors transform hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5">
